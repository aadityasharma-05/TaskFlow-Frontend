...
import { Sparkles, LayoutDashboard, Zap, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-white font-sans selection:bg-gray-900 selection:text-white">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
        <div className="w-full max-w-md">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">Sign in to TaskFlow</h2>
            <p className="text-gray-500 text-sm">Welcome back. Enter your details to access your workspace.</p>
          </div>
          ...
          <div className="mt-12 pt-6 border-t border-gray-100">
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Demo Credentials</h3>
            <div className="bg-gray-50 rounded-md p-4 text-xs font-mono text-gray-600 border border-gray-200">
              <div className="mb-1"><span className="text-gray-400">Email:</span> test@test.com</div>
              <div><span className="text-gray-400">Pass:</span> password123</div>
            </div>
          </div>
        </div>
      </div>
